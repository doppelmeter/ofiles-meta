...
def file_info(path_file):
    ...
    file_info["number_of_backgroundmaps"] = _string_count_backgroundmaps(
        string_dict)
...
def _string_mapnote(path_file_string_dict):
    ...
    #gets the list of all strings with the filterd typ
    string_list = _input_2_filterd_string_list(
        path_file_string_dict, filter=1061)
    if string_list == []:
        map_note = ""
    else:
...
def _string_count_spot_colors(path_file_string_dict):
    ...
    #gets the list of all strings with the filterd typ
    string_list = _input_2_filterd_string_list(
        path_file_string_dict, filter=10)
...
def _string_epsg_code(path_file_string_dict):
    ...
    #gets the list of all strings with the filterd typ
    string_list = _input_2_filterd_string_list(
        path_file_string_dict, filter=1039)
    try:
